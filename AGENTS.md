# csharp-live-text-to-speech

C# (.NET) demo app for Deepgram Live Text-to-Speech.
...
```
feat(csharp-live-text-to-speech): add diarization support
fix(csharp-live-text-to-speech): resolve WebSocket close handling
refactor(csharp-live-text-to-speech): simplify session endpoint
